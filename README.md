...
> The exact structure may vary depending on the implementation in this repository.
...
Connect the cameras and traffic-light GPIO circuitry according to the project's hardware configuration.

⚠️ **Do not connect LEDs or other components directly to GPIO pins without appropriate current-limiting/protection circuitry.**
...
Configuration parameters such as camera devices, model paths, GPIO mappings and inference settings can be adjusted according to the deployment setup.
